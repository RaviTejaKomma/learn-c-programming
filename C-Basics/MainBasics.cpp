...
int main(){
	...
	int countTemp = count(1, 123);
	printf("%d\n", countTemp);
	countTemp = count(3, 15);
	printf("%d\n", countTemp);
	countTemp = count(12, 55);
	printf("%d\n", countTemp);
	countTemp = count(234, 15);
	printf("%d\n", countTemp);
	...
	float numfrac = decimalToOctalFraction(12.22);
	printf("%f is the octal value of 12.22\n", numfrac); */
	//decimal to octal
	int num = decimalToOctal(1);
	printf("%d is the octal value of 12\n", num);
	num = decimalToOctal(130);
	printf("%d is the octal value of 12\n", num);
	num = decimalToOctal(12345);
	printf("%d is the octal value of 12\n", num);
	num = decimalToOctal(10000);
	printf("%d is the octal value of 12\n", num);
